...
url_d = {
        ...
        'print_const' : 'https://printnatkani.ru/constructor-test',
...
test_data = [
        ...
        '+790963000065', 
        'Aвтотест проверки работы сайта при помощи Selenium',
        'Самовывоз'
            ]
...
#--------- path to image to upload, file name to screenshot, db file--
foto_url_mx = '/home/alex/snake/print/93.jpg'
...
print(BASE_DIR, db_path, target_folder, foto_url, sep='\n')
